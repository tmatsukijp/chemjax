...
//      }
  ...
  xypic.Graphics.SVG.World = xypic.Graphics.SVG.Subclass({
    Init: function (height, depth, width, strokeWidth, color, def) {
      ...
      var def = {
      	//-- Modified by miura
        //fill:"none", stroke:color, "round",
        fill:"none", stroke:color, "stroke-linecap":"square",
      ...
      xypic.Shape.TextShape.Augment({
        _draw: function (svg, test) {
          ...
          var mathSpan = HTMLCSS.Element("span", {
            className:"MathJax", 
            style:{ "text-align":"center", "role":"textbox", "aria-readonly":"true", "position":"absolute", color:svg.getCurrentColor() /*, "border":"0.1px dashed" */, "font-family":"MathJax_Main" }
          });
...
MathJax.Ajax.loadComplete("[ChemJax]/xypic.js");
